      ...
      <div className="flex-col grid grid-rows-1 gap-2 p-4 mt-48">
        <div className="panels">
          ...
          <div className="contentPanel justify-center">
            <div className="row-span-1 grid grid-cols-3 text-primary-50">
              <img className="aboutMePics" src="src/assets/profile.jpg" alt="My profile image."></img>
              <img className="aboutMePics" src="src/assets/profile.jpg" alt="My profile image."></img>
              <img className="aboutMePics" src="src/assets/profile.jpg" alt="My profile image."></img>
            </div>
